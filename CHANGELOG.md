...
- Kubernetes multiple volumeMounts with subPath and 1 configmap volume - only 1 volumeMount works [\#1005](https://github.com/kubernetes/kompose/issues/1005)
...
- Docker build fails:  Failed to push image: unauthorized:authentication required [\#496](https://github.com/kubernetes/kompose/issues/496)
...
- Update the example to include NodePort and accessibility [\#409](https://github.com/kubernetes/kompose/pull/409) ([cdrage](https://github.com/cdrage))
...
- Change strategy for Deployments/DeploymentConfigs [\#264](https://github.com/kubernetes/kompose/issues/264)
...
- User directive from docker-compose is silently ignored [\#244](https://github.com/kubernetes/kompose/issues/244)
...
- Update RPM installation instructions in README.md [\#332](https://github.com/kubernetes/kompose/pull/332) ([kadel](https://github.com/kadel))
...
- Add flags for silencing warning and for treating warnings as error [\#100](https://github.com/kubernetes/kompose/issues/100)
...
- OpenShift conversion - invalid DeploymentConfig [\#124](https://github.com/kubernetes/kompose/issues/124)
...
- Breaking code in app.go to multiple packages [\#55](https://github.com/kubernetes/kompose/issues/55)
...
- Kompose help needs improvement [\#76](https://github.com/kubernetes/kompose/issues/76)
...
- Document unsupported fields [\#9](https://github.com/kubernetes/kompose/issues/9)
