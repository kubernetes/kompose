...
var bootstrap = function(t, e, n) {
  ...
  var s = function() {
          ...
          return n.toggle = function() {
            ...
            if (r) {
              ...
              if (o) {
                ...
                if (t) {
                  if (
                    o.hasAttribute("disabled") || r.hasAttribute("disabled") || o.classList.contains("disabled")
      ...
      var t = "carousel",
        ...
        f = function() {
          ...
          return f.next = function() {
            ...
            f.pause = function(t) {
              t || (this._isPaused = !0),
                e(this._element).find(d.NEXT_PREV)[0] && s.supportsTransitionEnd()
              ...
              if (
                ...
                s.supportsTransitionEnd() && e(this._element).hasClass(u.SLIDE)
                  ...
                  : (e(l).removeClass(u.ACTIVE),
                    ...
                    this._isSliding = !1,
                    e(this._element).trigger(p)), m && this.cycle();
              }
            },
          ...
          return d.toggle = function() {
            ...
            d.show = function() {
              ...
              if (!this._isTransitioning && !e(this._element).hasClass(h.SHOW)) {
                ...
                if (
                  this._parent
                  && ((r = e.makeArray(e(this._parent).children().children(u.ACTIVES))).length || (r = null)),
    ...
    u = function() {
        ...
        g = function() {
          ...
          return g.toggle = function() {
            if (!this._element.disabled && !e(this._element).hasClass(c.DISABLED)) {
              ...
              if (a._clearMenus(), !i) {
                ...
                if (e(t).trigger(r), !r.isDefaultPrevented()) {
                  var o = this._element;
                  e(t).hasClass(c.DROPUP) && (e(this._menu).hasClass(c.MENULEFT) || e(this._menu).hasClass(c.MENURIGHT))
                  && (o = t),
                    this._popper = new n(o, this._menu, this._getPopperConfig()),
                    "ontouchstart" in document.documentElement && !e(t).closest(u.NAVBAR_NAV).length
            ...
            a._dataApiKeydownHandler = function(t) {
              if (
                !(!l.test(t.which) || /button/i.test(t.target.tagName) && 32 === t.which
      ...
      return e(document).on(h.KEYDOWN_DATA_API, u.DATA_TOGGLE, g._dataApiKeydownHandler).on(
        h.KEYDOWN_DATA_API,
        u.MENU,
        g._dataApiKeydownHandler,
      ).on(h.CLICK_DATA_API + " " + h.KEYUP_DATA_API, g._clearMenus).on(h.CLICK_DATA_API, u.DATA_TOGGLE, function(t) {
          ...
          return u.toggle = function(t) {
            ...
            u._enforceFocus = function() {
              ...
              e(document).off(l.FOCUSIN).on(l.FOCUSIN, function(n) {
                document === n.target || t._element === n.target || e(t._element).has(n.target).length
                  || t._element.focus();
              });
            },
          ...
          return m.enable = function() {
            ...
            m.setElementContent = function(t, n) {
              ...
              "object" == typeof n && (n.nodeType || n.jquery)
                ? i ? e(n).parent().is(t) || t.empty().append(n) : t.text(e(n).text())
                : t[i ? "html" : "text"](n);
            },
            m.getTitle = function() {
            ...
            m._getConfig = function(n) {
              return "number" == typeof (n = e.extend({}, this.constructor.Default, e(this.element).data(), n)).delay
            ...
            u._process = function() {
              ...
              if (this._scrollHeight !== e && this.refresh(), t >= n) {
                ...
                if (this._activeTarget && t < this._offsets[0] && this._offsets[0] > 0) {return this._activeTarget =
                    null,
                    void this._clear();}
                for (var s = this._offsets.length; s--;) {this._activeTarget !== this._targets[s]
                    && t >= this._offsets[s] && ("undefined" == typeof this._offsets[s + 1] || t < this._offsets[s + 1])
      ...
      var t = e.fn.tab,
        ...
        a = function() {
          ...
          return a.show = function() {
            ...
            if (
              !(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE
                  && e(this._element).hasClass(i.ACTIVE) || e(this._element).hasClass(i.DISABLED))
            ) {
              ...
              if (
                a && e(a).trigger(u), e(this._element).trigger(d), !d.isDefaultPrevented() && !u.isDefaultPrevented()
              ) {
