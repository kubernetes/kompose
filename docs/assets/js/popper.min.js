 ...
 */ (function(e, t) {
  ...
  function m(e, t, o, i) {
    return X(
      ...
      o["scroll" + e],
      ne()
        ? o["offset" + e] + i["margin" + ("Height" === e ? "Top" : "Left")]
  ...
  function F(e, t, o) {
    ...
    if (!n) {
      var r = "`" + t + "`";
      console.warn(
        "`" + o + "`" + " modifier is required by " + r + " modifier in order to work, be sure to include it before "
          + r + "!",
      );
    }
    return n;
          ...
          fn: function(e, t) {
            ...
            return p.forEach(function(s, d) {
              ...
              var a = e.offsets.popper,
                ...
                w = !!t.flipVariations
                  && (y && "start" === r && c || y && "end" === r && h || !y && "start" === r && g
                    || !y && "end" === r && u);
              (m || b || w)
                && (e.flipped = !0,
                  (m || b) && (i = p[d + 1]),
        ...
        computeStyle: {
          ...
          fn: function(e, t) {
            ...
            var s,
              ...
              b = B("transform");
            if (
              d = "bottom" == h ? -f.height + c.bottom : c.top, s = "right" == u ? -f.width + c.right : c.left, a && b
