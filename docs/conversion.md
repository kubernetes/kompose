...
| pvc-request-size       | ✓  | ✓  | ✓  | PersistentVolumeClaim.Spec.Resources.Requests.Storage       | Easy to set the size of PVC request storage. The priority follow label (kompose.volume.size) > command parameter(--pvc-request-size) > defaultSize (100Mi) |
| restart                | ✓  | ✓  | ✓  |                                                             |                                                                                                                |
|                        |    |    |    |                                                             |                                                                                                                |
| __Volume__             | x  | x  | x  |                                                             |                                                                                                                |
| driver                 | x  | x  | x  |                                                             |                                                                                                                |
