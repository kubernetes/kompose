...
_Windows:_ Download from [GitHub](https://github.com/kubernetes/kompose/releases/download/v1.23.0/kompose-windows-amd64.exe) and add the binary to your PATH.
